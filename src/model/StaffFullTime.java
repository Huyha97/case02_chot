...
public class StaffFullTime extends Staff {
    ...
    public StaffFullTime(int id, String name, int age, String address, String code, String department, boolean status, boolean isClassify, int workingTimeOnMonth, int salaryOnHour) {
    ...
    public StaffFullTime(int workingTimeOnMonth, int salaryOnHour, double payRoll) {
        this.workingTimeOnMonth = workingTimeOnMonth;
        this.salaryOnHour = salaryOnHour;
        this.payRoll = payRoll;
    }
