...
public class ViewStaff {
    ...
    public static int menuManagerStaff() {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    controllerStaff.showInfo();
                    break;
                case 2:
                    controllerStaff.mySalary();
                    break;
                case 0:
                    ViewAccount.menuSignInAndSignUp();
                    break;
    ...
    public static int menuHeadOfDept() {
        ControllerAccount controllerAccount = new ControllerAccount();
        ControllerStaff controllerStaff = new ControllerStaff();
        ...
        while (true) {
            ...
            System.out.println("||        0. Log Out                                              ||");
            System.out.println("=======================WELCOME HEAD OF DEPT ========================");
            System.out.println("input your choice: ");
            int choice = 0;
            try {
                choice = Integer.parseInt(scanner.nextLine());
                if (choice != 0 && choice != 1 && choice != 2 && choice != 3 && choice != 4 && choice != 5) {
                    System.err.println("only type from 1 to 5, boy!");
                    return menuHeadOfDept();
                }
            } catch (Exception e) {
                System.err.println("only number is availabe!!!");
                return menuHeadOfDept();
            ...
            switch (choice) {
                case 1:
                    ...
                    ArrayList<Staff> arrayList1 = controllerStaff.displayAllStaffinDepartment(dept);
                ...
                case 2:
                    ...
                    try {
                        ...
                        if (choice1 != 1 && choice1 != 2 && choice1 != 3 && choice1 != 4) {
                            System.err.println("=====================");
                            System.err.println("|| ONLY FROM 1 TO 4 ||");
                            System.err.println("=====================");
                        }
                    } catch (Exception e) {
                        System.err.println("=====================");
