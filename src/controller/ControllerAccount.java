...
public class ControllerAccount {
    ...
    public boolean loginHeadOfIt(Account account) {
        return account.getUserName().equals("headofit") && account.getPassWord().equals("1234");
    }

    public boolean loginHeadOfSale(Account account) {
        return account.getUserName().equals("headofsale") && account.getPassWord().equals("1234");
    }
